<template>
  ...
  <div v-if="items.items && !isLoading">
    ...
    <div v-else class="flex flex-col items-center gap-4 mt-12 text-secondary">
      <Icon name="ph:smiley-sad-bold" class="text-6xl" />
      <p class="text-lg font-bold">There is no item to show</p>
    </div>
  </div>
